...
/* PHP build date */
#define PHP_BUILD_DATE "2021-05-21"

/* hardcode for each of the cross compiler host */
#define PHP_OS "Linux"

/* hardcode for each of the cross compiler host */
#define PHP_UNAME "Linux star-A 5.4.0-73-generic #82~18.04.1-Ubuntu SMP Fri Apr 16 15:10:02 UTC 2021 x86_64 x86_64 x86_64 GNU/Linux"
